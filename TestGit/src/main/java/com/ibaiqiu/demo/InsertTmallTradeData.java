...
public class InsertTmallTradeData {
...
//			String sql = "select * from jdp_tb_trade_Jessica_copy where tid = '221725346132634099'";
			String sql = "select * from jdp_tb_trade_jessica where tid = '221085388386365913'";
			...
			while(rs_barcode.next()) {
				...
				/*bc.setBarcode("6941288821045");
				bc.setNum_iid(539902889633L);*/
				list_barcode.add(bc);
				/*BarCode bc1 = new BarCode();
				bc1.setBarcode("6941288894759");
				bc1.setNum_iid(37754001720L);
