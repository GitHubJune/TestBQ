...
public class InsertTmallTradeData_compeled {
	...
	static String oid = "";
	static int num = 1;
	static double payment = 30*num;
	static boolean isMoreGood = true;
	/**
	 * get Trade_info
	 */
...
//			String sql = "select * from jdp_tb_trade where tid = '388935939484054287'";
			String sql = "select * from jdp_tb_trade where tid = '1652489102850132586'";
			...
			//while(rs_barcode.next()) {
				...
				BarCode bc1 = new BarCode();
				bc1.setBarcode("261123325050");
				bc1.setNum_iid(544537156297L);
				list_barcode.add(bc1);
				BarCode bc2 = new BarCode();
				bc2.setNum_iid(566324799348L);
				bc2.setBarcode("261123325045");
				list_barcode.add(bc2);
				
				BarCode bc3 = new BarCode();
				bc3.setNum_iid(566324799348L);
				bc3.setBarcode("261123325040");
				list_barcode.add(bc3);
			//}
...
//				System.out.println("tid--"+tid);
	...
	private static String jdp_response(String jdp_response) {
		...
		/*update money*/
		trade.put("price", Double.parseDouble(trade.getString("price")));
		trade.put("total_fee", payment);
		trade.put("payment", payment);
	...
	private static void packageMoreGoods(JSONArray order) {
		...
		orderone.put("num_iid", list_barcode.get(n).getNum_iid());
		orderone.put("num", num);
		orderone.put("payment", payment/2);
		orderone.put("price", Double.parseDouble(orderone.getString("price")));
		orderone.put("total_fee", payment/2);
//		orderone.put("title", trade.get("seller_nick")+list_barcode.get(n).getBarcode());
		orderone.put("status", status);
		...
		ordertwo.put("payment", payment/2);
		ordertwo.put("price", Double.parseDouble(orderone.getString("price")));
		ordertwo.put("total_fee", payment/2);
//		orderone.put("title", trade.get("seller_nick")+list_barcode.get(n).getBarcode());
...
//		JSONObject orderone = order.getJSONObject(0);
//		JSONObject ordertwo = order.getJSONObject(0);
//		JSONObject orderthree = order.getJSONObject(0);
//		order.add(ordertwo);
//		order.add(orderthree);
//		ordertwo = order.getJSONObject(1);
//		orderthree  = order.getJSONObject(2);
//		String trade_oid_1 = trade_tid();
//		orderone.put("oid", trade_oid_1);
//		orderone.put("oid_str", trade_oid_1);
//		int n = (int)(Math.random()*2);
...
//		orderone.put("num_iid", list_barcode.get(n).getNum_iid());
//		orderone.put("num", num);
//		orderone.put("payment", payment/3);
//		orderone.put("price", Double.parseDouble(orderone.getString("price")));
//		orderone.put("total_fee", payment/3);
////		orderone.put("title", trade.get("seller_nick")+list_barcode.get(n).getBarcode());
//		orderone.put("status", status);
//		
//		String trade_oid_2 = trade_tid();
...
//		ordertwo.put("num_iid", list_barcode.get(m).getNum_iid());
//		ordertwo.put("num", num);
//		ordertwo.put("payment", payment/3);
//		ordertwo.put("price", Double.parseDouble(orderone.getString("price")));
//		ordertwo.put("total_fee", payment/3);
////		orderone.put("title", trade.get("seller_nick")+list_barcode.get(n).getBarcode());
//		ordertwo.put("status", status);
//		
//		String trade_oid_3 = trade_tid();
//		orderthree.put("oid", trade_oid_3);
//		orderthree.put("oid_str", trade_oid_3);
//		orderthree.put("outer_sku_id", list_barcode.get(2).getBarcode());
//		orderthree.put("num_iid", list_barcode.get(2).getNum_iid());
//		orderthree.put("num", num);
//		orderthree.put("payment", payment/3);
//		orderthree.put("price", Double.parseDouble(orderone.getString("price")));
//		orderthree.put("total_fee", payment/3);
////		orderone.put("title", trade.get("seller_nick")+list_barcode.get(n).getBarcode());
//		orderthree.put("status", status);
//	}
